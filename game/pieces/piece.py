class Piece():
    ...
    def empty_or_can_eat(self, row, col, board):
        return board[row][col] is None or (board[row][col].color != self.color)  # and board[row][col].pgn_code !="K" mislim da ne treba jer svakako neces biti u prilici da pojedes kralja jer protivnik mora da se pomeri pre tvog poteza
